...
<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	<%
		...
		try{
			...
			String sql = " INSERT INTO member (member_id, member_pw, member_name, member_email, member_phone, member_addr1, member_addr2, member_addr3, member_gender, member_route, member_marketing) ";
			sql += " VALUES(?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?) ";
			...
			pstmt.setString(10, route);
			pstmt.setString(11, marketing);
