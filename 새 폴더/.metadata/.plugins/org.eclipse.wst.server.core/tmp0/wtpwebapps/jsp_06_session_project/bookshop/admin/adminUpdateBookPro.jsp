...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <%
	    String filePathStr = application.getRealPath("/bookshop/uploadedFile");
    ...
    try{ 
		...
		int index = Integer.parseInt(mr.getParameter("index"));
		...
		bookCategoryList[index] = bookCategory;
		bookSubCategoryList[index] = bookSubCategory;
		bookNameList[index] = bookName;
		bookPriceList[index] = bookPrice;
		bookDiscountList[index] = bookDiscount;
		bookInfoList[index] = bookInfo;
		bookStockList[index] = bookStock;
    	...
    	while(fileList.hasMoreElements()){				//첨부파일 끝까지 계속 반복
 			...
 			if(i == 0) {
 				bookImageList[index] = reFileName;
 			} else if(i == 1) {
 				bookContentImageList[index] = reFileName;
 			}
