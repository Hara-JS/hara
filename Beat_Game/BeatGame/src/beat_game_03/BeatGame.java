...
public class BeatGame extends JFrame {
	...
	public BeatGame() {
		...
		// 메인 클래스의 위치를 기반으로 해서 리소스 즉 introBackground라는 이미지 파일을 가져온 뒤 그 이미지 인스턴스를
		// introBackground라는 변수에 초기화를 시키겠다는 뜻
		...
		Music introMusic = new Music("In_My_Planet.mp3", true);
		introMusic.start();
	}
